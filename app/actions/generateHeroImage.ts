...
export async function generateHeroImage(
  ...
  try {
    ...
    const heroPrompts = {
      red: 'A superhero wearing a sleek, tight-fitting, flexible dark red and black suit with aerodynamic lines. Hero logo is a flame symbol. Hero has glowing red, stylized energy fins on the shoulders. The hero\'s face reveals sharp, focused eyes and tousled hair that suggests constant readiness and determination. The character is mid-action, slightly hovering as if ready to sprint at lightning speed, with a dynamic and adventurous pose. The background is a futuristic urban setting with a sense of motion and energy trails around the hero. Character exudes boldness, curiosity, and determination. Image in comic art style of Alex Ross.',
      blue: 'A hero wearing an advanced, high-tech cobalt blue suit with illuminated circuit patterns running throughout. Hero logo is a glowing brain symbol pulsing with blue energy. The suit features sleek armor plates with holographic interfaces and floating data projections. Midnight blue energy cores are visible at key points, powering the suit\'s advanced capabilities. The hero\'s face shows contemplative intelligence and strategic thinking, partially visible through a transparent hi-tech visor displaying augmented reality information. Hero stands confidently manipulating intricate holograms or generating a bridge of pure blue energy, surrounded by floating geometric light constructs. The background shows a high-tech cityscape with digital elements merging seamlessly with reality. Character exudes technological mastery and calculated precision. Image in comic art style of Alex Ross.',
      green: 'A powerful, nature-enhanced hero wearing deep-green combat armor with dynamic leaf patterns. Hero logo is a thorned leaf symbol. A rugged green cape billows behind the hero, edges shaped like serrated leaves. The armor incorporates natural elements like bark and vines, appearing both organic and formidable. The hero\'s face shows fierce determination and primal strength. Hero stands in a dynamic fighting stance, muscles tensed, with one hand commanding thorned vines while energy pulses through the natural elements of the suit. The background shows a fusion of urban and jungle elements, with the hero\'s presence causing plants to surge with power. Character exudes raw strength and untamed energy while maintaining a connection to nature. Image in comic art style of Alex Ross.',
